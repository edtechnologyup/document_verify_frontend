...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`https://document-verify-backend.onrender.com/api/get_pre_employees?email=${encodeURIComponent(email)}&password_hash=${encodeURIComponent(password)}`, {
        method: 'GET',
        headers: {
